...
mixin _$DeleteMerchantData {
  ...
  @JsonKey(ignore: true)
  $DeleteMerchantDataCopyWith<DeleteMerchantData> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $DeleteMerchantDataCopyWith<$Res> {
  factory $DeleteMerchantDataCopyWith(
          DeleteMerchantData value, $Res Function(DeleteMerchantData) then) =
      _$DeleteMerchantDataCopyWithImpl<$Res, DeleteMerchantData>;
  @useResult
  $Res call(
...
/// @nodoc
class _$DeleteMerchantDataCopyWithImpl<$Res, $Val extends DeleteMerchantData>
    implements $DeleteMerchantDataCopyWith<$Res> {
  _$DeleteMerchantDataCopyWithImpl(this._value, this._then);
...
abstract class _DeleteMerchantData implements DeleteMerchantData {
  const factory _DeleteMerchantData(
